...
Route::group(['prefix' => '/','middleware'=> 'auth'], function () {
    ...
    Route::put('rencana_aksi', [RencanaAksiController::class, 'Update']);
    Route::delete('rencana_aksi', [RencanaAksiController::class, 'Destroy']);
    ...
    Route::get('list_role_atasan', [MatrikPeranHasilController::class, 'ListRoleAtasan']);
